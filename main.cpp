...
public:
	...
	Player(String F, float X, float Y, float W, float H) {
		...
		x = X; y = Y;
		sprite.setTextureRect(IntRect(20, 50, w, h));
	}
...
int main()
{
	...
	Player p("walkingsprite.jpg", 40, 600, 144, 160);
	...
	while (window.isOpen())
	{
		...
		if (p.life) {
			if (Keyboard::isKeyPressed(Keyboard::Left)) {
				...
				p.sprite.setTextureRect(IntRect(144 * int(currentFrame), 210, 144, 160));
			}
			...
			if (Keyboard::isKeyPressed(Keyboard::Right)) {
				...
				currentFrame += 0.005*time;
				if (currentFrame > 9) currentFrame -= 9;
				p.sprite.setTextureRect(IntRect(144 * int(currentFrame), 30, 144, 160));
			}
			...
			if (Keyboard::isKeyPressed(Keyboard::Up)) {
				...
				currentFrame += 0.005*time;
				if (currentFrame > 9) currentFrame -= 9;
				p.sprite.setTextureRect(IntRect(144 * int(currentFrame), 560, 144, 160));
			}
			...
			if (Keyboard::isKeyPressed(Keyboard::Down)) {
				...
				currentFrame += 0.005*time;
				if (currentFrame > 9) currentFrame -= 9;
				p.sprite.setTextureRect(IntRect(144 * int(currentFrame), 380, 144, 160));
			}
